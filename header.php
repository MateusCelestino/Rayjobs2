            ...
            <nav class="site-navigation text-right" role="navigation">
              ...
              <ul class="site-menu js-clone-nav mr-auto d-none d-lg-block">
                ...
                <li class="dropdown order-1">
                    <button type="button" id="dropdownMenu1" data-toggle="dropdown" class="btn btn-outline-secondary dropdown-toggle">Faça seu login ou cadastre-se<span class="caret"></span></button>
                    <ul class="dropdown-menu dropdown-menu-right mt-2">
                       <li class="px-3 py-2">
                           <form class="form" role="form" style="width: 200px;">
                                ...
                                <div class="form-group text-center">
                                    <a href="#" style="display: block">Esqueci minha senha</a>
                                   <a href="cad_empresa.php" style="display: block">Cadastrar Empresa</a>
                                    <a href="cad_candidato.php">Cadastrar Candidato</a>
                                </div>
                            </form>
                        </li>
                    </ul>
                  ...
                  <form action="#" method="post">
                    <div class="row">
                      <div class="col-md-6 col-lg-3 mb-3 mb-lg-0">
                        <input type="text" class="form-control" placeholder="Vaga">
                      </div>
                      <div class="col-md-6 col-lg-3 mb-3 mb-lg-0">
           ...
           <div class="job-post-item bg-white p-4 d-block d-md-flex align-items-center">
              ...
              <div class="mb-4 mb-md-0 mr-5">
               <div class="job-post-item-header d-flex align-items-center">
                 <h2 class="mr-3 text-black h4">Supermercados Rondon</h2>
               ...
               <div class="job-post-item-body d-block d-md-flex">
                 ...
                 <div><span class="fl-bigmug-line-big104"></span> <span>Araçatuba, SP</span></div>
               </div>
              </div>
